...
namespace Branching
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    Console.WriteLine("It is colder tthan room temperature.");
            //}
            //else
            //{
            //    Console.WriteLine("Ughhhhh.....something went wrong");
            //}

            //Console.ReadLine();

            //string compairsonResult = currentTemperature == roomTemperature ?
